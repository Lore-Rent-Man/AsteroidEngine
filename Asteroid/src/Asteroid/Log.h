...
namespace Asteroid {
	...
	{
	public:
		ASTEROID_API static void Init();
		ASTEROID_API static std::shared_ptr<spdlog::logger>& GetCoreLogger();
		ASTEROID_API static std::shared_ptr<spdlog::logger>& GetClientLogger();
	private:
...
#define AS_CORE_INFO(...)  ::Asteroid::Log::GetCoreLogger()->info(__VA_ARGS__)
...
#define AS_INFO(...)       ::Asteroid::Log::GetClientLogger()->info(__VA_ARGS__)
